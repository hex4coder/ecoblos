    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        >
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                >
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        ...
                                        <p class="mt-4 text-sm/relaxed">
                                            Sistem ini adalah sistem pemilihan suara berbasis web dan android.
                                        </p>
                                    </div>
                                </div>
                        ...
                        >
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2
                                    class="text-xl font-semibold text-black dark:text-white"
                                >
                                    Double Choose Protection
                                </h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Dengan adanya sistem ini, tidak akan ada suara yang ganda dalam pemilihan.
                                </p>
                            </div>
                        ...
                        >
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2
                                    class="text-xl font-semibold text-black dark:text-white"
                                >
                                    Auto Calculations / Polling
                                </h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Perhitungan suara otomatis dengan sistem ranking.
                                </p>
                            </div>
                        ...
                        >
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <p class="mt-4 text-sm/relaxed">
                                    Sistem ini dibuat berbasis android sehingga, device android yang terkoneksi dijadikan alat untuk pemilihan suara.
                                    Jumlah device android yang terhubung bisa diatur.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                >
                    Dibuat oleh Ardan, S.Kom @ LAB UPTD SMKN Campalagian
                </footer>
            </div>
        </div>
    </div>
